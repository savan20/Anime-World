...
const Drama = () => {
  ...
  const filtereddramaAnime = dramaAnimeList.filter((anime) =>
  ...
  return (
    <div className="genre-page">
      ...
      <div className="genre-header">
        <h1>Drama Anime</h1>
        <p>Immerse yourself in the world of intense and emotional drama with our curated collection.</p>
      </div>
      <div className="anime-list">
        {filtereddramaAnime.length > 0 ? (
          filtereddramaAnime.map((anime) => (
            <AnimeCard
              key={anime.id}
              image={anime.image}
              name={anime.name}
